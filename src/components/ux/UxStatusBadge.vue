<template>
  <span class="ux-status-badge" :style="badgeStyle">
    <span class="ux-status-badge__dot" :style="dotStyle"></span>
    <span class="ux-status-badge__text">{{ text }}</span>
    <span v-if="count != null" class="ux-status-badge__count">{{ count }}</span>
  </span>
</template>
