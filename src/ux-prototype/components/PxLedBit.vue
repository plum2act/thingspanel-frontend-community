<template>
  <span class="px-led" :class="on ? 'px-led--on' : 'px-led--off'" :style="styleVars">
    <span class="px-led__dot"></span>
    <span class="px-led__label">{{ label }}</span>
    <span class="px-led__txt">{{ on ? 'ON' : 'OFF' }}</span>
  </span>
</template>
